...
public class PastDay_Games extends AsyncTask<String, Integer, List<Game>> {
    private static final String TAG = "PastDay_Games";
    private Context context;
    private String mdate;

    public PastDay_Games(Context context) {
    ...
    protected List<Game> doInBackground(String... strings) {
        try {
            ...
            for (int i=0; i < array.length(); i++) {
                ...
                game.setscores(gamejson.getJSONObject("vTeam").getInt("score"),gamejson.getJSONObject("hTeam").getInt("score"));
                games.add(game);
            }
            return games;
        }
